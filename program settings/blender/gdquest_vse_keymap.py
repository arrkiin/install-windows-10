...
kmi = km.keymap_items.new('gdquest_vse.toggle_sequences_muted', 'H', 'PRESS')
kmi = km.keymap_items.new('gdquest_vse.toggle_sequences_muted', 'H', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('gdquest_vse.delete_direct', 'X', 'PRESS')
...
kmi = km.keymap_items.new('gdquest_vse.speed_up_sequence', 'S', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('gdquest_vse.border_select', 'B', 'PRESS')
...
kmi = km.keymap_items.new('gdquest_vse.smart_snap', 'K', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'side', 'left')
kmi = km.keymap_items.new('gdquest_vse.smart_snap', 'K', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'side', 'right')
kmi = km.keymap_items.new('gdquest_vse.fade_strips', 'F', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'fade_type', 'left')
kmi = km.keymap_items.new('gdquest_vse.fade_strips', 'F', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'fade_type', 'right')
kmi = km.keymap_items.new('gdquest_vse.channel_offset', 'UP_ARROW', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'direction', 'up')
kmi = km.keymap_items.new('gdquest_vse.channel_offset', 'DOWN_ARROW', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'direction', 'down')
kmi = km.keymap_items.new('gdquest_vse.concatenate_strips', 'C', 'PRESS', shift=True)
kmi = km.keymap_items.new('gdquest_vse.sound_toggle_waveform', 'W', 'PRESS')
kmi = km.keymap_items.new('gdquest_vse.add_crossfade', 'C', 'PRESS', ctrl=True, alt=True)
...
kmi = km.keymap_items.new('gdquest_vse.fade_strips', 'F', 'PRESS')
kmi_props_setattr(kmi.properties, 'fade_type', 'both')
kmi = km.keymap_items.new('gdquest_vse.mouse_cut', 'LEFTMOUSE', 'CLICK', ctrl=True)
...
kmi = km.keymap_items.new('gdquest_vse.mouse_cut', 'RIGHTMOUSE', 'CLICK', ctrl=True)
kmi_props_setattr(kmi.properties, 'select_mode', 'smart')
kmi_props_setattr(kmi.properties, 'cut_mode', 'trim')
kmi_props_setattr(kmi.properties, 'remove_gaps', True)
kmi_props_setattr(kmi.properties, 'cursor_offset', 8)
kmi = km.keymap_items.new('gdquest_vse.edit_crossfade', 'C', 'PRESS', alt=True)
kmi = km.keymap_items.new('gdquest_vse.delete_direct', 'DEL', 'PRESS')
kmi = km.keymap_items.new('sequencer.gap_remove', 'BACK_SPACE', 'PRESS')
kmi_props_setattr(kmi.properties, 'all', True)
kmi = km.keymap_items.new('sequencer.select', 'RIGHTMOUSE', 'PRESS')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'linked_handle', False)
kmi_props_setattr(kmi.properties, 'left_right', 'NONE')
kmi_props_setattr(kmi.properties, 'linked_time', False)
kmi = km.keymap_items.new('gdquest_vse.render_video', 'F12', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'use_proxies', False)
kmi_props_setattr(kmi.properties, 'preset', 'youtube')
kmi = km.keymap_items.new('gdquest_vse.import_local_footage', 'I', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'keep_audio', True)
kmi = km.keymap_items.new('gdquest_vse.add_title_marker', 'M', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('gdquest_vse.add_numbered_marker', 'M', 'PRESS', ctrl=True, alt=True)
kmi = km.keymap_items.new('sequencer.view_all', 'HOME', 'PRESS')
kmi = km.keymap_items.new('sequencer.view_selected', 'END', 'PRESS')
kmi = km.keymap_items.new('gdquest_vse.add_transform_effect', 'T', 'PRESS')
kmi = km.keymap_items.new('gdquest_vse.ripple_delete', 'X', 'PRESS', shift=True)
kmi = km.keymap_items.new('gdquest_vse.preview_last_cut', 'P', 'PRESS', shift=True)
kmi = km.keymap_items.new('gdquest_vse.mouse_cut', 'ACTIONMOUSE', 'PRESS', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'select_mode', 'cursor')
kmi_props_setattr(kmi.properties, 'cut_mode', 'cut')
kmi = km.keymap_items.new('gdquest_vse.toggle_preview_selection', 'P', 'PRESS', ctrl=True, alt=True)
...
kmi_props_setattr(kmi.properties, 'linked_time', True)
kmi = km.keymap_items.new('gdquest_vse.mouse_cut', 'SELECTMOUSE', 'PRESS', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'select_mode', 'cursor')
kmi_props_setattr(kmi.properties, 'cut_mode', 'trim')
kmi_props_setattr(kmi.properties, 'remove_gaps', True)
kmi = km.keymap_items.new('gdquest_vse.cycle_scenes', 'TAB', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('gdquest_vse.save_direct', 'S', 'PRESS', ctrl=True)
